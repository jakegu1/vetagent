...
TOOLS = [
    {
        ...
        "description": (
            ...
            "is open source, and on Solana the mint/freeze authority and the SPL "
            "Token-2022 extensions (transfer fee, permanent delegate, transfer hook, "
            "frozen-by-default) — plus the aggregate verdicts of upstream security "
            "scanners.\n"
            "The sell simulation covers Ethereum, BSC and Base only. On Solana nothing "
            "here tests whether a holder can sell, so a Solana answer comes back "
            "'unknown' rather than 'low'; Solana holder concentration is unavailable "
            "while the upstream omits holders.\n"
