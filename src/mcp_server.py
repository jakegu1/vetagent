...
TOOLS = [
    {
        ...
        "description": (
            ...
            "Covers on Solana: the mint/freeze authority and the SPL Token-2022 "
            "extensions (transfer fee, permanent delegate, transfer hook, "
            "frozen-by-default), plus the RugCheck score.\n"
