...
|---|---|---|---|---|
| **in 6 days** | 2026-09-18 | W10 | Create the two accounts the remaining directories need | no |
| **in 6 days** | 2026-09-18 | W11 | Answer the 2026-09-18 gate | no |
| **in 6 days** | 2026-09-18 | -- | Post Experiment C | no |
| in 34 days | 2026-10-16 | W5 | A second, independent sell-simulation source | **yes -- see below** |
| in 34 days | 2026-10-16 | W12 | Decide the price-history trade-off | no |

### W10 Create the two accounts the remaining directories need

- **When:** 2026-09-18 (**in 6 days**)
...
|---|---|---|---|
| 2026-09-18 | **in 6 days** | Is anyone using it | Yes → continue; no → run only Experiment C, add no features |
| 2026-10-16 | in 34 days | Does anyone want to pay | Yes → build payments; no → pick a different customer segment and run D again |
| 2026-12-04 | in 83 days | Is further investment worth it | Yes → continue per §7; no → move to low-maintenance mode |
| 2027-03-04 | in 173 days | Does the data asset hold up | Yes → that becomes the main product; no → keep the tool, drop the data narrative |
...
gantt
    ...
    section Decisions
    Is anyone using it - in 6 days :milestone, 2026-09-18, 0d
    Does anyone want to pay - in 34 days :milestone, 2026-10-16, 0d
    Is further investment worth it - in 83 days :milestone, 2026-12-04, 0d
    Does the data asset hold up - in 173 days :milestone, 2027-03-04, 0d
```
...
**9 days, no gaps.** Newest is 2026-09-11, yesterday.
...
- R20-2: the gate cannot tell a browser GET from an MCP tool call
- R20-3: "frozen, pinned by tests/test_usage_gate.py" did not pin what decides the answer
- R20-9: the owner page reddened by itself every midnight, and was red at HEAD today
- Probe tagging becomes a mechanism: a hook, not a note
...
_159 more not shown (167 commits in total)._
