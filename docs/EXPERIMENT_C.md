...
> - 21.2% (122 of 576) of benchmark answers are `unknown` (fail-closed); the live service returned 43.4% of 83 answers from 2026-09-15 to 09-22, a figure that includes our own monitoring and demo traffic. 94 of the 122 benchmark unknowns are one free upstream not indexing the token or its simulation reverting.
...
> - `unknown`: **21.2%** in the benchmark; 43.4% live (09-15 to 09-22, including our own monitoring and demo traffic). 94 of the 122 benchmark unknowns trace to one free upstream.
