...
> **Consolidation is overdue.** This table is at 56 rows against a stated ceiling of
...
| E17 | Silencing a detection costs more than raising one | The honeypot override cleared at \$5k liquidity and 20 sells: a whitelist honeypot's own wallets buy that for gas. Now \$25k standing and 100 sells at 30%, far above the bar the same evidence needs merely to be *reported* -- reporting beside an open question is free, switching off an alarm is not | `test_overturning_a_honeypot_verdict_needs_distinct_sellers` | Active |
